...
class Colors:
    ...
    def __init__(self):
        ...
        hexs = ('FF3838', '00FF00', 'FF701F', 'FFB21D', 'CFD231','48F90A', '92CC17', '3DDB86', '1A9334', '00D4BB',
...
class Annotator:
    ...
    def box_label(self, box, label='', color=(128, 128, 128), txt_color=(255, 255, 255),trajectory=None):
        ...
        if self.pil or not is_ascii(label):
            ...
            if trajectory is not None:
                ...
                for t in trajectory[-30:]:
                    line_list.append((int(t[0]+t[2]/2), int(t[1]+t[3]/2)))
                for i in range(1,len(line_list)):
                    cv2.line(self.im,line_list[i-1],line_list[i],color,2)
            if label:
