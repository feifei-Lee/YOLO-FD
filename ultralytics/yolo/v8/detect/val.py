...
class DetectionValidator(BaseValidator):
    ...
    def get_seg_dataloader(self, dataset_path, batch_size=16, rank=-1, mode='val'):
        if self.args.v5loader:
...
def val(cfg=DEFAULT_CFG, use_python=False):
    ...
    # model = 'C:\\Users\\zhaor\\PycharmProjects\\ultralytics-main\\ultralytics\\yolo\\v8\\detect\\runs\\detect\\' \
    #         'train305-150epo\\weights\\last.pt'
    model = 'C:\\Users\zhaor\PycharmProjects\\ultralytics-main\pre_weights\mtl\pcgrad+uncert\weights\\best.pt'
    # model = 'C:\yolov8_result\\v8_150epo_train07_12\weights\last.pt'
    # model = 'C:\\Users\\zhaor\\PycharmProjects\\ultralytics-main\\yolov8s.pt'
    # model = 'C:\\Users\\zhaor\\PycharmProjects\\ultralytics-main\\pre_weights\\last.pt'
    batch = 8   # cfg.batch * 2
