...
# def get_params():
#     params = {
#         'weight': 'pre_weights/mtl/pcgrad+uncert/weights/best.pt',
#         'cfg': 'ultralytics/models/v8/yolov8s.yaml',
#         'device': 'cuda:0',
...
# def get_params():
#     params = {
#         'weight': 'pre_weights/mtl/det only/weights/best.pt',
#         'cfg': 'ultralytics/models/v8/yolov8s.yaml',
#         'device': 'cuda:0',
#         'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM
#         'layer': 'model.model[14]',
...
def get_params():
    params = {
        'weight': 'pre_weights/mtl_voc/train on voc12seg 300epo yolov8ds unweight+pcgrad/weights/best.pt',
        'cfg': 'ultralytics/models/v8/yolov8s.yaml',
        'device': 'cuda:0',
        'method': 'GradCAM',  # GradCAMPlusPlus, GradCAM, XGradCAM
        'layer': 'model.model[8]',
...
if __name__ == '__main__':
    ...
    # model(r'compare_pic/0909_024291.jpg', 'result')
    model(r'compare_pic/QQ20231115164245.png', 'mresult')
